...
const verifyAndRecordAttendance = async (req, res) => {
    ...
    try {
        ...
        if (employee_id) {
            ...
            const result = await (0, db_1.query)('SELECT id, employee_id, full_name, face_embedding FROM employees WHERE (id::text = $1 OR employee_id = $1) AND face_embedding IS NOT NULL', [employee_id]);
