...
const t1 = evaluateCheckIn('09:05:00', settings);
...
const t2 = evaluateCheckIn('09:20:00', settings);
...
const t3 = evaluateCheckIn('03:49 PM', settings);
...
const t3b1 = evaluateCheckIn('12:51 PM', settings);
...
const t3b2 = evaluateCheckIn('2026-07-30 12:51:00', settings);
...
const t3b3 = evaluateCheckIn('2026-07-30T12:51:00.000Z', settings);
...
const t4 = evaluateCheckOut('09:00:00', '19:00:00', true, 20, settings);
